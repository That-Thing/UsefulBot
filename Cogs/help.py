...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name='!!settings', value="Shows a list of settings and their state", inline=False)
        embed.add_field(name='!!settings level', value="Allows for enabling/disabling of level-up messages", inline=False)
        ...
        embed.add_field(name='!!catfact', value="Shows you a fact about a cat", inline=False)
        embed.add_field(name='!!dogfact', value="Shows you a fact about a dog", inline=False)
        ...
        embed.add_field(name='!!upscale *image*', value='Upscales an image', inline=False)
        embed.add_field(name='!!cat', value='Sends a cat', inline=False)
        embed.add_field(name='!!dog', value='Sends a dog', inline=False)
        embed.add_field(name='!!bird', value='Sends a bird', inline=False)
        ...
        embed.add_field(name='!!fortune', value='Gets a fortune', inline=False)
        await author.send(embed=embed)
        embed = discord.Embed(title="Command List 8: Level Commands", colour=random.choice(colors))
        embed.add_field(name='!!level', value='Checks your level', inline=False)
        await author.send(embed=embed)
